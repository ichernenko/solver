...
class GeoPeaksCountries {
    private static final String selectSql = "select id,flag_number from dic_countries";
    private static final String selectSeaSql = "select id,country from dic_peaks";
    private static final String insertSql = "insert into dic_peaks_countries(peak_id,country_id) values (?,?)";
    ...
    public static void main(String[] args) throws IOException {
        GeoPeaksCountries geoPeaksCountries = new GeoPeaksCountries();
        geoPeaksCountries.loadDBDriver();
        geoPeaksCountries.parseSite();
    }
}