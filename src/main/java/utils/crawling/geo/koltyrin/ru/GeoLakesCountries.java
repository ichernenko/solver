...
class GeoLakesCountries {
    private static final String selectSql = "select id,flag_number from dic_countries";
    private static final String selectSeaSql = "select id,country from dic_lakes";
    private static final String insertSql = "insert into dic_lakes_countries(lake_id,country_id) values (?,?)";
    ...
    public static void main(String[] args) throws IOException {
        GeoLakesCountries geoLakesCountries = new GeoLakesCountries();
        geoLakesCountries.loadDBDriver();
        geoLakesCountries.parseSite();
    }
}