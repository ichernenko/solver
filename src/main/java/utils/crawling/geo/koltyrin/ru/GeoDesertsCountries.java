...
class GeoDesertsCountries {
    private static final String selectSql = "select id,flag_number from dic_countries";
    private static final String selectSeaSql = "select id,country from dic_deserts";
    private static final String insertSql = "insert into dic_deserts_countries(desert_id,country_id) values (?,?)";
    ...
    public static void main(String[] args) throws IOException {
        GeoDesertsCountries geoDesertsCountries = new GeoDesertsCountries();
        geoDesertsCountries.loadDBDriver();
        geoDesertsCountries.parseSite();
    }
}