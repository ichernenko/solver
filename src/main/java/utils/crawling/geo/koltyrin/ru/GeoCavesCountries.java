...
class GeoCavesCountries {
    private static final String selectSql = "select id,flag_number from dic_countries";
    private static final String selectSeaSql = "select id,country from dic_caves";
    private static final String insertSql = "insert into dic_caves_countries(cave_id,country_id) values (?,?)";
    ...
    public static void main(String[] args) throws IOException {
        GeoCavesCountries geoCavesCountries = new GeoCavesCountries();
        geoCavesCountries.loadDBDriver();
        geoCavesCountries.parseSite();
    }
}