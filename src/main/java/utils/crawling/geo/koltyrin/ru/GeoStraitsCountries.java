...
class GeoStraitsCountries {
    private static final String selectSql = "select id,flag_number from dic_countries";
    private static final String selectSeaSql = "select id,country from dic_straits";
    private static final String insertSql = "insert into dic_straits_countries(strait_id,country_id) values (?,?)";
    ...
    public static void main(String[] args) throws IOException {
        GeoStraitsCountries geoStraitsCountries = new GeoStraitsCountries();
        geoStraitsCountries.loadDBDriver();
        geoStraitsCountries.parseSite();
    }
}